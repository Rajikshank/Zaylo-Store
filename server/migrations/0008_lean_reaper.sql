ALTER TABLE "password_reset_tokens" ALTER COLUMN "id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "two_factor_tokens" ALTER COLUMN "id" SET NOT NULL;--> statement-breakpoint
